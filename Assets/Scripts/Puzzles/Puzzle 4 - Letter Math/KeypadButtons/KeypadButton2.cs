...
public class KeypadButton2 : MonoBehaviour, IInteractable
{
    ...
    public void Interact()
    {
        ...
        else if (StateNameConptroller.currentPass == "")
        {
            StateNameConptroller.currentPass = StateNameConptroller.currentPass + 2;
        }
